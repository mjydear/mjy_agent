...
async def create_session(
    ...
    return SessionCreateResponse(
        session=service.create_session(request.title, tenant=tenant)
    )
...
async def list_sessions(
    ...
    """
    return service.list_sessions(tenant=tenant)
...
async def get_session(
    ...
    """
    return service.get_session(session_id, tenant=tenant)
...
async def delete_session(
    ...
    """
    return service.delete_session(session_id, tenant=tenant)
