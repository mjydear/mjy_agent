...
class SkillValidator:
    ...
    async def validate(
        ...
        # Weighted floating-point arithmetic can represent an exact threshold
        # such as 0.5 as 0.49999999999999994.
        epsilon = 1e-9
        accepted = (
            score + epsilon >= self.acceptance_threshold
            and success_rate + epsilon >= self.acceptance_threshold
        )
        reason = (
