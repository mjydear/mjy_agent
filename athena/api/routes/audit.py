...
async def list_audit_events(
    ...
    tenant_id: str | None = Query(
        default=None,
        description="System auditors with audit:read:any may select a tenant.",
    ),
    ...
    events = service.list_audit_events(
        tenant, limit=limit, target_tenant_id=tenant_id
    )
...
async def verify_audit_chain(
    ...
    """
    return service.verify_audit_chain(tenant=tenant)
